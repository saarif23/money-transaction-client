    ...
    <div className="flex flex-col lg:flex-row max-w-screen-xl mx-auto gap-12 px-6 2xl:px-0 my-6 md:my-8 lg:my-12">
      <div className="lg:w-3/4 space-y-6">
        ...
        <p className="text-white">
          Living abroad? Our service simplifies money transactions. No more
          banking hassles or conversion fees. Get paid locally, worldwide.
          Swift, secure transactions on our platform. Manage finances
          effortlessly while abroad. Freelancing, remote work, or exploring
          internationally? Trust us for easy, reliable money management.
        </p>
        <div className="text-white space-y-3">
          <div className="bg-[#0e0e0e] p-4 rounded-full">
            <p className="flex items-center gap-2">
              <MdOutlineCheckCircle size={22} className="primary-color" />
