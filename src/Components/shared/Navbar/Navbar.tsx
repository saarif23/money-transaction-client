...
import { AppBar, Box, Container, Drawer, IconButton, List, ListItem, ListItemButton, ListItemText, Stack, Typography, Button, Divider } from "@mui/material";
...
function Navbar() {
  ...
  return (
    <>
      <AppBar position="fixed" sx={{ backgroundColor: "#009286" }}>
        <Container sx={{
          display: "flex",
          alignItems: "center",
